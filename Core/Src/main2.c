...
// start_cycle will get set 1 by SysTick_Handler every 1000ms. Then when main while loop has
// ended get reset 0.
uint8_t start_cycle = 1;
uint16_t raw_value_ADC;
float temp;
char msg[30];
